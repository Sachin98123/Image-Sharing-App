...
import 'package:insta_closachin/state/image_upload/helpers/image_picker_helper.dart';
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (_) => CreateNewPostView(
                        fileToPost: videoFile, fileType: FileType.videos),
                  ),
                );
              },
            ...
            IconButton(
              onPressed: () async {
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (_) => CreateNewPostView(
                        fileToPost: imageFile, fileType: FileType.images),
                  ),
                );
              },
